...
# (shebang + headless matplotlib backend added for bin/-on-PATH execution under Nextflow;
#  body otherwise vendored verbatim from veltenlab/CloneTracer clonal_inference/run_clonetracer.py)
...
#PATCHED sys.stdout = open("logs/"+name+"/"+name+"_stdout.txt", "w")
#PATCHED sys.stderr = open("logs/"+name+"/"+name+"_stderr.txt", "w")
